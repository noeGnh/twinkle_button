...
import 'package:twinkle_button/widgets/shimmer.dart';
...
class TwinkleButton extends StatefulWidget {
  ...
  @override
  State<TwinkleButton> createState() => _TwinkleButtonState();
}
...
class _TwinkleButtonState extends State<TwinkleButton> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _twinkleCount = 0;
    _controller =
        AnimationController(vsync: this, duration: Duration(milliseconds: widget.twinkleTime), lowerBound: 0.0, upperBound: 0.1)
          ..addListener(() {
            setState(() {});
          })
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(onTap: widget.onclickButtonFunction, child: Transform.scale(scale: _scale, child: _twinkleButton));
  }

  Widget get _twinkleButton => Center(
    child: Stack(
      children: <Widget>[
        SizedBox(
        ...
        Container(
          ...
          child: Opacity(
            ...
            child: Shimmer.fromColors(
              ...
              child: Container(width: widget.buttonWidth, height: widget.buttonHeight, decoration: BoxDecoration(color: widget.buttonColor, borderRadius: BorderRadius.all(Radius.circular(25.0)))),
            ),
          ),
        ),
        Container(width: widget.buttonWidth, height: widget.buttonHeight, decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(25.0))), child: Center(child: widget.buttonTitle)),
      ],
    ),
  );
}
